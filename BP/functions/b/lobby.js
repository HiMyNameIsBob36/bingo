## RED
execute as @a at @s if block ~~-1~ red_concrete run tellraw @s[tag=!red] {"rawtext":[{"text":"GAME §l§s>> §rJoined §l§cRED§r team."}]}
...
## BLUE
execute as @a at @s if block ~~-1~ light_blue_concrete run tellraw @s[tag=!blue] {"rawtext":[{"text":"GAME §l§s>> §rJoined §l§bBLUE§r team."}]}
...
## GREEN
execute as @a at @s if block ~~-1~ lime_concrete run tellraw @s[tag=!green] {"rawtext":[{"text":"GAME §l§s>> §rJoined §l§2GREEN§r team."}]}
...
## YELLOW
execute as @a at @s if block ~~-1~ yellow_concrete run tellraw @s[tag=!yellow] {"rawtext":[{"text":"GAME §l§s>> §rJoined §l§eYELLOW§r team."}]}
