...
## BLUE
execute as @a at @s if block ~~-1~ light_blue_concrete run tellraw @s[tag=!blue] {"rawtext":[{"text":"§lGAME §r§s>> §rJoined §bBLUE§r team."}]}
...
## GREEN
execute as @a at @s if block ~~-1~ lime_concrete run tellraw @s[tag=!green] {"rawtext":[{"text":"§lGAME §r§s>> §rJoined §1GREEN§r team."}]}
...
## YELLOW
execute as @a at @s if block ~~-1~ yellow_concrete run tellraw @s[tag=!yellow] {"rawtext":[{"text":"§lGAME §r§s>> §rJoined §eYELLOW§r team."}]}
